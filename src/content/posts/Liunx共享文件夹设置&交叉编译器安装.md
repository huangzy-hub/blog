---
title: Liunx共享文件夹设置&交叉编译器安装
published: 2025-12-27
pinned: false
description: liunx虚拟机与主机/开发板之间共享文件夹设置及交叉编译器安装笔记
tags: [liunx, 虚拟机]
category: 嵌入式
draft: false
---
...
```bash
# 桌面解压后的bin目录绝对路径
export PATH=$PATH:/home/huangzy/桌面/gcc-linaro-7.2.1-2017.11-x86_64_arm-linux-gnueabi/bin
```
...
- 如果没有就工具包里找
```bash
# 在sdk中查找库文件（根据你的实际路径调整）
find /桌面/gcc-linaro-7.2.1-2017.11-x86_64_arm-linux-gnueabi/arm-linux-gnueabi/libc/lib/ -name "libc.so.6"
find /桌面/gcc-linaro-7.2.1-2017.11-x86_64_arm-linux-gnueabi/arm-linux-gnueabi/libc/lib/ -name "ld-linux.so.3"
```
